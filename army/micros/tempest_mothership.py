...
class TempestMothershipMicro(MicroABS):
    def __init__(self, ai):
        super().__init__('TempestMothershipMicro', ai)
        self.targets_dict = {}
        ...
        for tempest in tempests:
            if enemy.exists:
                ...
                if detectors.exists:
                    ...
                    threats = enemy.filter(
                        lambda z: z.distance_to(tempest.position) < dist and not z.is_hallucination)
            ...
            if threats:
                ...
                if motherships.exists:
                    ...
                    if tempest.distance_to(mothership) > 5:
                        tempest.move(mothership)
                        continue
