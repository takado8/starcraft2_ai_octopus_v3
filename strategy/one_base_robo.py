...
class OneBaseRobo(Strategy):
    def __init__(self, ai):
        super().__init__(type='mid', name='OneBaseRobo', ai=ai)
        ...
        self.army.create_division('main', {unit.IMMORTAL: 5, unit.COLOSSUS: 3, unit.DISRUPTOR: 4},
    ...
    def attack_condition(self):
        return (self.condition_attack.army_supply_over(40) and not self.ai.after_first_attack) or (self.condition_attack.blink_research_ready_raw()
