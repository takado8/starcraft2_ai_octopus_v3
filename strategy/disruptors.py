...
class Disruptors(Strategy):
    def __init__(self, ai):
        super().__init__(type='mid', name='Disruptors', ai=ai)
        ...
        self.army.create_division('main', {unit.IMMORTAL: 5, unit.STALKER: 15, unit.DISRUPTOR: 20, unit.WARPPRISM: 1},
        ...
        build_queue = BuildQueues.DISRUPTORS
    ...
    def attack_condition(self):
        return (self.condition_attack.army_supply_over(60) and not self.ai.after_first_attack) or (self.condition_attack.blink_research_ready_raw()
