...
class CannonRushDefenseUpdated(Strategy):
    def __init__(self, ai):
        ...
        locations_dict = positions_loader.load_positions_dict('main_ramp_lock_down')
        build_queue = BuildQueues.CANNON_RUSH_DEFENSE2
