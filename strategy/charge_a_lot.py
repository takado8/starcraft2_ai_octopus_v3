...
class ChargeALotUpdated(Strategy):
    def __init__(self, ai):
        super().__init__(type='rush', name='ChargeALotUpdated', ai=ai)
        ...
        self.army.create_division('main', {unit.ZEALOT: 25, unit.SENTRY: 2, unit.STALKER: 7, unit.IMMORTAL: 3,
        ...
        build_queue = BuildQueues.CHARGE_A_LOT
    ...
    async def execute_interfaces(self):
        ...
        if self.ai.enemy_race == Race.Terran and self.ai.time > 300:
    ...
    def attack_condition(self):
        return self.condition_attack.army_supply_over(90) and not self.ai.first_attack or self.condition_attack.total_supply_over(195)
