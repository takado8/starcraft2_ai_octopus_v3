...
class StalkerMid(StrategyABS):
    def __init__(self, ai):
        super().__init__(type='macro', name='stalker_mid')
        self.ai = ai
        self.army = Army(ai)
        ...
        self.army.create_division('zealot1', ZEALOT_x10, [zealot_micro])
        self.army.create_division('zealot2', ZEALOT_x10, [zealot_micro])
